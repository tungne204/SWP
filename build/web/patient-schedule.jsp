        ...
        <div class="row">
            ...
            <div class="col-md-2 bg-dark text-white min-vh-100 p-3">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link text-white active" href="PatientScheduleController">
                    ...
                    <form method="GET" class="row g-3">
                        <div class="col-md-3">
                            ...
                            <select name="filter" id="filterType" class="form-select">
                                ...
                                <option value="date" ${currentFilter == 'date' ? 'selected' : ''}>By Date</option>
                                <option value="range" ${currentFilter == 'range' ? 'selected' : ''}>Date Range</option>
                            </select>
                        </div>
                        
                        <div class="col-md-3" id="dateFilter" style="display: ${currentFilter == 'date' ? 'block' : 'none'}">
                            <label class="form-label">Select Date</label>
                            <input type="date" name="date" class="form-control" value="${selectedDate}">
                        </div>
                        
                        <div class="col-md-2" id="fromDateFilter" style="display: ${currentFilter == 'range' ? 'block' : 'none'}">
                            <label class="form-label">From Date</label>
                            <input type="date" name="fromDate" class="form-control" value="${selectedFromDate}">
                        </div>
                        
                        <div class="col-md-2" id="toDateFilter" style="display: ${currentFilter == 'range' ? 'block' : 'none'}">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            ...
                            <a href="PatientScheduleController" class="btn btn-outline-secondary">
                ...
                <div class="card schedule-card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">
                            ...
                            Appointments (${appointments.size()} found)
                        </h5>
                    </div>
                    <div class="card-body">
                        <c:choose>
                                            ...
                                            <div class="card appointment-card h-100">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        ...
                                                        <span class="badge status-badge ${appointment.status ? 'status-active' : 'status-inactive'}">
