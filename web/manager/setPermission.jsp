...
<html lang="vi">
    ...
    <body class="bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 min-h-screen">
        ...
        <div class="gradient-bg text-white py-8 mb-10 shadow-2xl">
            <div class="container mx-auto px-4">
                ...
                <div class="text-center mt-10">
                    <a href="Home.jsp"
                       class="inline-block px-6 py-3 text-white font-medium rounded-lg bg-indigo-500 hover:bg-indigo-600 shadow-md transition-all">
                        ← Trở về Trang Chính
                    </a>
                </div>
            </div>
        ...
        <div id="alertMessage"
             class="max-w-3xl mx-auto mb-6 px-6 py-3 rounded-lg shadow-lg text-white
