        ...
        <div class="page-header">
            <div class="container">
                <div class="d-flex align-items-center">
                    <a href="${pageContext.request.contextPath}/manager/doctors?action=view&id=${doctorId}" 
                       class="btn btn-light me-3">
                        <i class="fas fa-arrow-left"></i>
                    </a>
                    <div>
                        <h1 class="mb-0">Thêm Bằng cấp</h1>
                        <p class="mb-0 mt-2">Thêm thông tin bằng cấp cho bác sĩ</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card form-card">
                    <div class="card-body p-4">
                        <form action="${pageContext.request.contextPath}/manager/doctors" 
                            ...
                            <input type="hidden" name="action" value="insertQualification">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" 
                                          ...
                                          name="description" 
                                          rows="3" 
                                          placeholder="Mô tả chi tiết về bằng cấp (không bắt buộc)"></textarea>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Lưu bằng cấp
                                </button>
                            </div>
                        </form>
                    </div>
