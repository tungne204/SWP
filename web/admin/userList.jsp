                                ...
                                <c:otherwise>
                                    <c:forEach var="user" items="${users}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="${pageContext.request.contextPath}/admin/users?action=view&group=${group}&id=${user.userId}" class="btn btn-primary btn-sm">
                        ...
                        <div style="margin-top: 25px; display: flex; justify-content: center; gap: 6px;">
                            <c:forEach var="i" begin="1" end="${totalPages}">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <a href="?action=list&group=${group}&page=${i}&search=${search}&roleFilter=${roleFilter}&statusFilter=${statusFilter}"
