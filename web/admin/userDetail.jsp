            ...
            <div class="main-content">
                <div class="container-box">
                    <h1><i class="fas fa-user-circle"></i>
                        <c:choose>
                            <c:when test="${group == 'staff'}"> Chi tiết nhân viên</c:when>
                            <c:otherwise> Chi tiết khách</c:otherwise>
                        </c:choose>
                    </h1>
                    ...
                    <c:if test="${empty user}">
                        <div class="alert alert-warning text-center">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/users?action=list&group=${group}" class="btn btn-secondary">
