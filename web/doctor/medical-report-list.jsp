...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            /* Header Section - Medilab Style (Màu dịu mắt) */
            .header-section {
                background: linear-gradient(135deg, #7dd3d7 0%, #5ec4c9 100%);
                color: white;
                padding: 3rem 0;
                margin-bottom: 2rem;
                box-shadow: 0 4px 15px rgba(93, 196, 201, 0.15);
            }
            ...
            /* Optional: Nếu muốn center align header */
