  ...
  <body>
    ...
    <div class="container">
      ...
      <c:if test="${not empty sessionScope.message}">
        <div
          class="alert alert-${sessionScope.messageType} alert-dismissible fade show"
          role="alert"
        >
          <i
            class="fas fa-${sessionScope.messageType == 'success' ? 'check-circle' : 'exclamation-circle'}"
          ></i>
          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              <ul class="nav nav-pills">
                <li class="nav-item">
                  <a
                    class="nav-link ${viewType == 'all' ? 'active' : ''}"
                ...
                <li class="nav-item">
                  <a
                    class="nav-link ${viewType == 'pending' ? 'active' : ''}"
        ...
        <div class="card-header">
          <h5>
            ...
            <c:choose>
              ...
              <c:when test="${viewType == 'completed'}">
                Danh sách bệnh nhân đã khám (Hoàn thành)
              </c:when>
              <c:when test="${viewType == 'by-date'}">
                Lịch hẹn ngày ${selectedDate} (${appointmentCount} lịch)
              </c:when>
              <c:otherwise> Tất cả lịch hẹn </c:otherwise>
            </c:choose>
          </h5>
        </div>
        <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group" role="group">
                        <a
                          href="appointment?action=view&id=${apt.appointmentId}"
                        ...
                        <c:if test="${apt.hasMedicalReport}">
                          <a
                            href="medical-report?action=view&id=${apt.recordId}"
                        ...
                        <c:if test="${!apt.hasMedicalReport}">
                          <a
                            href="medical-report?action=add&appointmentId=${apt.appointmentId}"
                            class="btn btn-sm btn-primary"
                            title="Kê đơn thuốc"
                          >
                    ...
                    <td colspan="8" class="empty-state">
                      ...
                      <p>
                        <c:choose>
                          ...
                          <c:when test="${viewType == 'completed'}">
                            Không có bệnh nhân đã khám
                          </c:when>
                          <c:when test="${viewType == 'by-date'}">
                            Không có lịch hẹn trong ngày này
                          </c:when>
                          <c:otherwise> Chưa có lịch hẹn nào </c:otherwise>
                        </c:choose>
                      </p>
                    </td>
                  </tr>
      ...
      <div class="card quick-links-card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-3">
              <a
                href="medical-report?action=list"
                class="btn btn-outline-primary w-100 mb-2"
              >
                <i class="fas fa-prescription-bottle-medical"></i> Quản lý đơn
                thuốc
              </a>
            </div>
            <div class="col-md-3">
              <a
                href="test-result?action=list"
            ...
            <div class="col-md-3">
              <a
                href="appointment?action=completed"
                class="btn btn-outline-info w-100 mb-2"
              >
                <i class="fas fa-check-circle"></i> Bệnh nhân đã khám
              </a>
            </div>
          </div>
        </div>
