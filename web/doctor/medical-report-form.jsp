...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            .rx-page .rx-form-header .breadcrumb {
                margin: 8px 0 0 0;
            }
            .rx-page .rx-form-header .breadcrumb a {
                color: #3498db;
                text-decoration: none;
            }
            .rx-page .rx-form-header .breadcrumb a:hover {
                color: #2c3e50;
            }
            ...
            .rx-page .form-label i {
                color: #3498db;
            }
            .rx-page .required::after {
                content: " *";
                color: #e74c3c;
            }
            ...
            .rx-page .btn-primary:hover {
                background: #2980b9;
            }
            .rx-page .btn-secondary {
                background: #7f8c8d;
                color: #fff;
            }
            .rx-page .btn-secondary:hover {
                background: #636e72;
            }

            /* Guide */
            .rx-page .guide-section {
                background: #f8f9fa;
                border-radius: 8px;
                padding: 1rem;
            }
            .rx-page .guide-section h6 {
                font-weight: 600;
                color: #34495e;
            }
            ...
            <div class="rx-layout">
                ...
                <div class="rx-content">
                    ...
                    <div class="card rx-card">
                        ...
                        <div class="card-body">
                            <!-- ... phần header/alert/breadcrumb giữ nguyên ... -->
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <c:if test="${empty appointments}">
                                            <div class="alert alert-warning mt-2">
                                                <i class="fas fa-info-circle me-2"></i> Không có lịch khám nào chưa có báo cáo
                                            </div>
                                        </c:if>
                                    </div>
                                </c:if>
