...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            * {
            ...
            .btn-dashboard {
                background: linear-gradient(135deg, #3fbbc0, #2a9ca1);
                color: white;
                border: none;
                border-radius: 25px;
            ...
            .btn-dashboard:hover {
                background: linear-gradient(135deg, #2a9ca1, #3fbbc0);
                transform: translateY(-2px);
                box-shadow: 0 6px 15px rgba(63, 187, 192, 0.4);
                color: #fff;
            }
    ...
    <body>
        ...
        <div class="container text-end mb-3">
            <a href="doctor-dashboard" class="btn btn-dashboard">
                <i class="fas fa-arrow-left"></i> Trở về trang chính bác sĩ
            </a>
        </div>
