        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item">
              <a href="medical-report?action=list" class="text-white"
                >Đơn thuốc</a
              >
            </li>
            <li class="breadcrumb-item">
              <a href="test-result?action=list" class="text-white"
                >Xét nghiệm</a
              >
            </li>
            <li class="breadcrumb-item active text-white-50">
              Chi tiết #${testResult.testId}
            </li>
          </ol>
        </nav>
      </div>
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between">
            <div>
              ...
              <a
                href="test-result?action=view-by-record&recordId=${testResult.recordId}"
                class="btn btn-info"
              >
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <div class="info-value">${testResult.patientName}</div>
              </div>
              <div class="mb-3">
                <div class="info-label">
                ...
                <div class="info-value">
                  <a
                    href="medical-report?action=view&id=${testResult.recordId}"
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <div class="info-value">${testResult.date}</div>
              </div>
              <div class="mb-3">
                <div class="info-label">
                  <i class="fas fa-notes-medical"></i> Chẩn đoán ban đầu
                </div>
                <div class="info-value">${testResult.diagnosis}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          ...
          <div class="text-center mt-4">
            <p class="small text-muted">
              Phòng khám nhi khoa - Địa chỉ: 123 ABC, Hà Nội - Hotline:
              1900-xxxx
            </p>
          </div>
        </div>
