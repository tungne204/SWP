...
<body>
    <div class="container mt-4">
        ...
        <div class="alert alert-success" role="alert">
            ...
            <p>Kết quả xét nghiệm của bệnh nhân đã được nhập vào hệ thống thành công.</p>
            <hr>
            <p class="mb-0">Bệnh nhân sẽ được ưu tiên trở lại hàng đợi để tiếp tục khám bệnh.</p>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p>Bệnh nhân đã được chuyển sang trạng thái <strong>"Sẵn Sàng Khám Lại"</strong> với mức độ ưu tiên cao.</p>
                <p>Khi bác sĩ hoàn tất ca khám hiện tại, bệnh nhân này sẽ được ưu tiên gọi vào khám tiếp theo.</p>
            </div>
        </div>
